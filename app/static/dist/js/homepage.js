...
qwest.get('/polls/all').then(function (xhr, response) {
    createCharts(response.polls);
}).catch(function (e) {
    console.log(e);
});

var createCharts = function createCharts(res) {
...
var createCanvas = function createCanvas(config) {
    console.log('called');
    console.log(config);
...
var generateColors = function generateColors(howmany) {
    var result = [];
