...
var 
  ...
  getClass = (el) => document.getElementsByClassName(el),
  create   = (el) => document.createElement(el);

//====SELECTORS AND GLOBAL VARIABLES====================================
var 
  $modalWrap =  getId('modalcontain'),
...
var createDivs = (poll) =>{
  ...
  linkbutton.id = 'sharebutton-'+countsofar,
  linkbutton.innerHTML = 'SHARE',
  deletebutton.id = 'deletebutton-'+countsofar,
  ...
  linkwrapper.href= "/single?pollid="+poll._id,
  deletewrapper.href="/polls/delete/"+poll._id,
  linkwrapper.classList.add('linkwrapper'),
  linkwrapper.classList.add('buttonwrapper'),
  deletewrapper.classList.add('deletewrapper'),
  deletewrapper.classList.add('buttonwrapper');
  ...
  pollbuttons.appendChild(deletewrapper),
  pollbuttons.appendChild(linkwrapper);

  //====TITLE OF POLL==============================================
  title.href="/single?pollid="+poll._id,
  title.innerHTML=poll.name;
  title.classList.add('title');

  //====DIV CONTAINING EVERYTHING===================================
  onepoll.classList.add('onepoll'),
  onepoll.appendChild(title),
  onepoll.appendChild(pollbuttons);

  //====WRAPPER FOR THE ABOVE DIV====================================
  li.classList.add('onepollwrap'),
  li.appendChild(onepoll);
