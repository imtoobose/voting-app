...
$add.addEventListener('click', (e)=>{
  ...
  var 
    ...
    check.id = "optcheck-"+countsofar,
    check.classList.add('check'),
    check.classList.add('optioncheck');

    radio.id   = "opt-"+countsofar,
    radio.type = "radio",
    radio.name = "voteName",
    radio.value = countsofar,
    radio.classList.add('vote'),
    radio.classList.add('optionvote');

    input.name        = "addoption",
    input.id          = "addoption-"+countsofar,
    input.type        = "text",
    ...
    label.for = "addoption-"+countsofar,
    label.id  = "contain-"+countsofar;

    li.classList.add("addoptioncontain"),
    li.innerHTML = "Option "+countsofar;
    ...
    getId("polloptions").appendChild(li);
});
